...
import RightForChcekbox from "../rightSidebar/RightForChcekbox";
import RightForRadio from "../rightSidebar/RightForRadio";

const RpanelForRadio = () => {
