...
const ButtonRightPanel = () => {
  ...
  let exampleList = [
    { listName: "Default Click", path: "button" },
    { listName: "Right Click", path: "button/buttonRightClick" },
    { listName: "Double Click", path: "button/buttonDoubleClick" },
    { listName: "Submit Click", path: "button/buttonSubmitClick" },
    { listName: "Disabled", path: "button/buttonDisabled" },
  ];
...
export default ButtonRightPanel;
